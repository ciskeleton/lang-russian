...
$lang['admin_install_update_confirm'] = 'Вы уверены, что хотите обновить этот пакет?';
$lang['admin_install_update_error'] = 'Не удалось обновить пакет.';
$lang['admin_install_update_skip_confirm'] = 'Вы уверены, что хотите пропустить это обновление?';
$lang['admin_install_update_skip_error'] = 'Не удалось пропустить это обновление.';
$lang['admin_install_update_skip_success'] = 'Обновление успешно пропущено.';
$lang['admin_install_update_success'] = 'Пакет успешно обновлён.';
...
$lang['admin_modules_delete_error_active'] = 'Активные модули нельзя удалить.';
...
$lang['admin_modules_global'] = 'Глобальный модуль (общий)';
$lang['admin_modules_install_confirm'] = 'Вы уверены, что хотите установить модуль: <b>%s</b>?';
$lang['admin_modules_install_error'] = 'Не удалось установить модуль.';
$lang['admin_modules_install_success'] = 'Модуль успешно установлен.';
...
$lang['admin_modules_update_confirm'] = 'Вы уверены, что хотите обновить этот модуль?';
$lang['admin_modules_update_error'] = 'Не удалось обновить модуль.';
$lang['admin_modules_update_success'] = 'Модуль успешно обновлён.';
...
$lang['admin_plugins_delete_error_active'] = 'Активные плагины нельзя удалить.';
...
$lang['admin_plugins_global'] = 'Глобальный плагин (общий)';
$lang['admin_plugins_install_confirm'] = 'Вы уверены, что хотите установить плагин: <b>%s</b>?';
$lang['admin_plugins_install_error'] = 'Не удалось установить плагин.';
$lang['admin_plugins_install_success'] = 'Плагин успешно установлен.';
...
$lang['admin_plugins_update_confirm'] = 'Вы уверены, что хотите обновить этот плагин?';
$lang['admin_plugins_update_error'] = 'Не удалось обновить плагин.';
$lang['admin_plugins_update_success'] = 'Плагин успешно обновлён.';
...
$lang['admin_themes_disable_error_active'] = 'Активную тему нельзя отключить.';
...
$lang['admin_themes_install_confirm'] = 'Вы уверены, что хотите установить тему: <b>%s</b>?';
$lang['admin_themes_install_error'] = 'Не удалось установить тему.';
$lang['admin_themes_install_success'] = 'Тема успешно установлена.';
...
$lang['admin_themes_update_confirm'] = 'Вы уверены, что хотите обновить эту тему?';
$lang['admin_themes_update_error'] = 'Не удалось обновить тему.';
$lang['admin_themes_update_success'] = 'Тема успешно обновлена.';
...
$lang['admin_languages_delete_confirm'] = 'Вы уверены, что хотите удалить язык: <b>%s</b>?';
$lang['admin_languages_delete_error'] = 'Не удалось удалить язык.';
$lang['admin_languages_delete_error_active'] = 'Активные языки нельзя удалить.';
$lang['admin_languages_delete_error_default'] = 'Язык по умолчанию нельзя удалить.';
$lang['admin_languages_delete_success'] = 'Язык успешно удалён.';
...
$lang['admin_languages_install_confirm'] = 'Вы уверены, что хотите установить язык: <b>%s</b>?';
$lang['admin_languages_install_error'] = 'Не удалось установить язык.';
$lang['admin_languages_install_success'] = 'Язык успешно установлен.';
...
$lang['admin_languages_update_confirm'] = 'Вы уверены, что хотите обновить этот язык?';
$lang['admin_languages_update_error'] = 'Не удалось обновить язык.';
$lang['admin_languages_update_success'] = 'Язык успешно обновлён.';
 ...
 */
$lang['package_already_exists'] = 'Пакет уже существует.';
$lang['package_archive_download_failed'] = 'Не удалось скачать архив пакета.';
$lang['package_backup_create_error'] = 'Не удалось создать резервную копию пакета.';
$lang['package_backup_dir_failed'] = 'Не удалось создать каталог резервной копии %s';
$lang['package_backup_missing'] = 'Файл резервной копии не существует.';
$lang['package_backup_path_error'] = 'Не удалось определить путь к файлу резервной копии.';
$lang['package_backup_request_invalid'] = 'Неверный запрос резервной копии.';
$lang['package_backup_restore_error'] = 'Не удалось восстановить резервную копию пакета.';
$lang['package_catalog_type_unknown'] = 'Неизвестный тип каталога.';
$lang['package_checksum_error'] = 'Проверка контрольной суммы (checksum) пакета не удалась.';
$lang['package_copy_files_error'] = 'Не удалось скопировать файлы пакета в пункт назначения.';
$lang['package_copy_updates_error'] = 'Не удалось скопировать файлы обновления в пункт назначения.';
$lang['package_dest_dir_failed'] = 'Не удалось создать целевой каталог %s';
$lang['package_destination_error'] = 'Не удалось определить целевой путь пакета.';
$lang['package_download_dir_failed'] = 'Не удалось создать каталог для скачивания %s';
$lang['package_download_empty'] = 'Загрузка пакета вернула пустой ответ.';
$lang['package_download_request_invalid'] = 'Неверный запрос загрузки пакета.';
$lang['package_extract_failed'] = 'Не удалось распаковать ZIP-архив %s';
$lang['package_invalid_lang_files'] = 'Неверный язык — отсутствуют обязательные языковые файлы приложения.';
$lang['package_invalid_lang_structure'] = 'Неверный язык — отсутствуют каталоги admin и/или ci3.';
$lang['package_invalid_missing_info'] = 'Недопустимый %s: отсутствует файл "info.php".';
$lang['package_invalid_module_structure'] = 'Неверный модуль — отсутствуют обязательные каталоги config и/или controllers.';
$lang['package_invalid_plugin_boot'] = 'Неверный плагин — отсутствует файл "boot.php".';
$lang['package_invalid_plugin_contents'] = 'Неверный плагин — плагины не могут содержать контроллеры или представления (views).';
$lang['package_invalid_theme_boot'] = 'Неверная тема — отсутствует файл "boot.php".';
$lang['package_invalid_theme_views'] = 'Неверная тема — отсутствует каталог views.';
$lang['package_no_root_dir'] = 'Пакет не содержит корневого каталога.';
$lang['package_not_downloadable'] = 'Пакет недоступен для публичной загрузки.';
$lang['package_not_in_registry'] = 'Пакет недоступен в публичном реестре.';
$lang['package_request_invalid'] = 'Неверный запрос пакета.';
$lang['package_rollback_request_invalid'] = 'Неверный запрос отката (rollback).';
$lang['package_root_mismatch'] = 'Корневой каталог архива пакета не соответствует %s';
$lang['package_single_root_required'] = 'Пакет должен содержать ровно один корневой каталог.';
$lang['package_source_error'] = 'Не удалось определить источник пакета.';
$lang['package_system_core_restricted'] = 'Системные компоненты не могут быть установлены в виде пакетов.';
$lang['package_temp_dir_failed'] = 'Не удалось создать временный каталог %s';
$lang['package_type_unknown'] = 'Неизвестный тип пакета.';
$lang['package_update_request_invalid'] = 'Неверный запрос обновления пакета.';
$lang['package_update_root_mismatch'] = 'Корневой каталог архива обновления не соответствует %s.';
$lang['package_upload_dir_failed'] = 'Не удалось создать каталог для загрузки %s';
$lang['package_url_invalid'] = 'Неверный URL распространения пакета.';
$lang['package_write_failed'] = 'Не удалось записать пакет в %s';
$lang['package_zip_not_found'] = 'ZIP-пакет не существует: %s';
...
$lang['update_rollback_confirm'] = 'Вы уверены, что хотите восстановить предыдущую версию?';
